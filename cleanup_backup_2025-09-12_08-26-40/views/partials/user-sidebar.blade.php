<div class="flex-1 bg-gray-800 text-gray-200 sticky top-0 h-screen">
    ...
    <nav class="hide-scrollbar flex-1 px-2 py-2 overflow-y-auto space-y-1 md:block" x-cloak>
        ...
        <a href="{{ route('providers.index') }}"
            class="flex items-center px-3 py-2 rounded-md transition-all duration-150 {{ request()->routeIs('providers.*') ? 'bg-gray-700' : '' }} text-gray-200 hover:bg-gray-700" title="Service Providers">
            <svg class="h-5 w-5 mr-2" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4">
                </path>
            </svg>
            <span class="text-sm" x-show="!$root.sidebarCollapsed">Service Providers</span>
        </a>
        ...
        <a href="{{ route('parenting-modules.index') }}"
            class="flex items-center px-3 py-2 rounded-md transition-all duration-150 {{ request()->routeIs('parenting-modules.*') ? 'bg-gray-700' : '' }} text-gray-200 hover:bg-gray-700" title="Parenting Modules">
            <svg class="h-5 w-5 mr-2" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253">
                </path>
            </svg>
            <span class="text-sm" x-show="!$root.sidebarCollapsed">Parenting Modules</span>
        </a>

        <!-- Training Modules -->
        <a href="{{ route('training-modules.index') }}"
            class="flex items-center px-3 py-2 rounded-md transition-all duration-150 {{ request()->routeIs('training-modules.*') ? 'bg-gray-700' : '' }} text-gray-200 hover:bg-gray-700" title="Training Modules">
            <svg class="h-5 w-5 mr-2" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253">
                </path>
        ...
        <a href="{{ route('ai-chat.index') }}"
            class="flex items-center px-3 py-2 rounded-md transition-all duration-150 {{ request()->routeIs('ai-chat.*') ? 'bg-gray-700' : '' }} text-gray-200 hover:bg-gray-700" title="AI Assistant">
            <svg class="h-5 w-5 mr-2" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
